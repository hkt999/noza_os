...
#include "noza_term.h"
static noza_term_t term; // TODO: maybe consider multiple terminals
#define lua_initreadline(L)  ((void)L, term_init(&term, "lua> "))
#define lua_readline(L,b,p)  ((void)L, (term_readline(&term, b, LUA_MAXINPUT)!=NULL))
